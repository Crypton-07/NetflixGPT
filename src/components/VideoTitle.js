...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-screen aspect-video sm:pt-[15%] md:pt-[15%] lg:pt-[18%] px-16 absolute bg-gradient-to-r from-black bg-opacity-100">
      <h1 className="text-4xl font-bold text-white w-1/2">{title}</h1>
      <p className="py-4 text-md sm:w-2/3 lg:w-[45%] text-white">{overview}</p>
